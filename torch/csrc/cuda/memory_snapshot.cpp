...
std::string _memory_snapshot_pickled() {
  ...
  IValue pinned_max_round_size_mb_s = "pinned_max_round_size_mb";
  IValue pinned_max_cached_size_mb_s = "pinned_max_cached_size_mb";
