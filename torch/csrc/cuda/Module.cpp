...
PyObject* THCPModule_memorySnapshot(PyObject* _unused, PyObject* arg) {
  ...
  py::str pinned_max_round_size_mb_s = "pinned_max_round_size_mb";
  py::str pinned_max_cached_size_mb_s = "pinned_max_cached_size_mb";
  ...
  allocator_settings[pinned_max_round_size_mb_s] =
      int64_t(snapshot.config_metadata.pinned_max_round_size_mb);
  allocator_settings[pinned_max_cached_size_mb_s] =
      int64_t(snapshot.config_metadata.pinned_max_cached_size_mb);
